...
var apiManagementSubnetName = 'snet-api-management'
...
resource apiManagementNsg 'Microsoft.Network/networkSecurityGroups@2024-05-01' = {
  ...
  properties: {
    securityRules: [
      ...
      {
        name: 'AllowPrivateBackendsOutbound'
        properties: {
          priority: 120
          direction: 'Outbound'
          access: 'Allow'
...
resource apiManagementSubnet 'Microsoft.Network/virtualNetworks/subnets@2024-05-01' existing = {
  parent: vnet
  name: apiManagementSubnetName
}
