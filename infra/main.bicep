...
output AZURE_AI_CHAT_DEPLOYMENT_NAME string = resources.outputs.AZURE_AI_CHAT_DEPLOYMENT_NAME
output FOUNDRY_PROJECT_ENDPOINT string = resources.outputs.FOUNDRY_PROJECT_ENDPOINT
output AZURE_TAGS string = resources.outputs.AZURE_TAGS
output AZURE_APPLICATION_LOCATION string = resources.outputs.AZURE_APPLICATION_LOCATION
output AZURE_APPLICATION_RESOURCE_TOKEN string = resources.outputs.AZURE_APPLICATION_RESOURCE_TOKEN
...
output AZURE_CONTAINER_ENVIRONMENT_DEFAULT_DOMAIN string = resources.outputs.AZURE_CONTAINER_ENVIRONMENT_DEFAULT_DOMAIN
...
output AZURE_MANAGED_IDENTITY_RESOURCE_ID string = resources.outputs.AZURE_MANAGED_IDENTITY_RESOURCE_ID
output AZURE_WEB_MANAGED_IDENTITY_CLIENT_ID string = resources.outputs.AZURE_WEB_MANAGED_IDENTITY_CLIENT_ID
output AZURE_WEB_MANAGED_IDENTITY_PRINCIPAL_ID string = resources.outputs.AZURE_WEB_MANAGED_IDENTITY_PRINCIPAL_ID
output AZURE_WEB_MANAGED_IDENTITY_RESOURCE_ID string = resources.outputs.AZURE_WEB_MANAGED_IDENTITY_RESOURCE_ID
...
output RESEARCH_CONNECTOR_GATEWAY_URL string = resources.outputs.RESEARCH_CONNECTOR_GATEWAY_URL
output RESEARCH_CONNECTOR_GATEWAY_TOKEN_SCOPE string = resources.outputs.RESEARCH_CONNECTOR_GATEWAY_TOKEN_SCOPE
output RESEARCH_WORKSPACE_TENANT_ID string = resources.outputs.RESEARCH_WORKSPACE_TENANT_ID
output RESEARCH_WORKSPACE_PROJECT_ID string = resources.outputs.RESEARCH_WORKSPACE_PROJECT_ID
output RESEARCH_ENTRA_AUTH_ENFORCED string = resources.outputs.RESEARCH_ENTRA_AUTH_ENFORCED
output RESEARCH_ENTRA_TENANT_ID string = resources.outputs.RESEARCH_ENTRA_TENANT_ID
output RESEARCH_ENTRA_API_CLIENT_ID string = resources.outputs.RESEARCH_ENTRA_API_CLIENT_ID
