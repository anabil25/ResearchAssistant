...
maturity filtering, workspace connections, GA-only memory scopes,
deterministic release gates, behavioral approvals and admin escalation,
development deployments with health/rollback metadata, and stable
