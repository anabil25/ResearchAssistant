...
export const INTERACTION_MANIFEST: readonly InteractionContract[] = [
  ...
  },
  {
    ...
    behavior: "Enables/disables optional connectors while protecting required dependencies.",
    baseline: "functional-uncovered",
    milestone: "M9",
  ...
  },
  {
    ...
    behavior: "Persists allowlisted agent assignments and prevents invalid combinations.",
    baseline: "functional-uncovered",
    milestone: "M9",
  ...
  },
  {
    ...
    behavior: "Runs a bounded audited test and updates health/freshness.",
    baseline: "functional-covered",
    milestone: "M9",
    states: ["ready", "testing", "healthy", "degraded", "failed"],
