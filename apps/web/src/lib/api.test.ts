...
describe("apiFetch / ApiError", () => {
  ...
  it("resolves with the parsed JSON body on a 2xx response", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents",
...
describe("agent studio endpoints (/agent-studio/...)", () => {
  ...
  it("gets one exact release contract by version", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/releases/1.2.0",
      expect.anything(),
    );
  });
  ...
  it("gets the full release history for an agent", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/releases",
      expect.anything(),
    );
  });
  ...
  it("gets the mutable draft contract", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/draft",
      expect.anything(),
    );
  });
  ...
  it("gets the capability descriptor catalog", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/capabilities/descriptors",
      expect.anything(),
    );
  });
  ...
  it("gets the discovered capability instance catalog", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/capabilities/instances",
      expect.anything(),
    );
  });
  ...
  it("gets the combined capability discovery aggregate", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/capabilities/discovery",
      expect.anything(),
    );
  });
  ...
  it("gets discovered project model deployments", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/models",
      expect.anything(),
    );
  });
  ...
  it("gets an agent's bound connections", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/connections",
      expect.anything(),
    );
  });
  ...
  it("gets an agent's health summary", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/health",
      expect.anything(),
    );
  });
  ...
  it("gets an agent's advisory evaluation summary", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/evaluation",
      expect.anything(),
    );
  });
  ...
  it("gets an agent's deployment status", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/deployment",
      expect.anything(),
    );
  });
  ...
  it("gets an agent's recent traces", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/traces",
      expect.anything(),
    );
  });
  ...
  it("gets an agent's per-scope memory view", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/memory",
      expect.anything(),
    );
  });
  ...
  it("updates one memory scope with a partial patch", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/memory/conversation",
      expect.objectContaining({
        method: "PUT",
  ...
  it("forgets one memory scope", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/memory/project/forget",
      expect.objectContaining({ method: "POST" }),
    );
  });
  ...
  it("posts a builder message with the message and base etag", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/drafts/draft-1/builder/messages",
      expect.objectContaining({
        method: "POST",
  ...
  it("applies a builder proposal with the proposal id and base etag", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/drafts/draft-1/proposals/proposal-1/apply",
      expect.objectContaining({
        method: "POST",
  ...
  it("creates a new draft from an intent", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/drafts",
  ...
  it("forks an agent without a version, omitting the query string", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/fork",
      expect.objectContaining({ method: "POST" }),
    );
  });
  ...
  it("forks a specific released version, url-encoding the version", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "/api/backend/v1/agent-studio/agents/literature/fork?version=1.2.0%2Bbuild",
      expect.objectContaining({ method: "POST" }),
    );
  });
});
