...
def test_list_capability_instances_is_tenant_and_project_scoped(
    ...
    all_for_tenant = client.get("/api/agent-studio/capabilities/instances", headers=USER_HEADERS)
    ...
    other_tenant = client.get("/api/agent-studio/capabilities/instances", headers=OTHER_TENANT_HEADERS)
...
def test_capability_discovery_combines_descriptors_instances_and_warnings(
    ...
    response = client.get("/api/agent-studio/capabilities/discovery", headers=USER_HEADERS)
...
def test_list_templates_returns_built_in_catalog_ordered_by_id_then_version(client: TestClient) -> None:
    response = client.get("/api/agent-studio/templates", headers=USER_HEADERS)
    assert response.status_code == 200
    body = response.json()
...
def test_list_templates_rejects_invalid_limit_and_offset(client: TestClient) -> None:
    too_low = client.get("/api/agent-studio/templates", params={"limit": 0}, headers=USER_HEADERS)
    assert too_low.status_code == 422

    too_high = client.get("/api/agent-studio/templates", params={"limit": 201}, headers=USER_HEADERS)
    assert too_high.status_code == 422

    negative_offset = client.get("/api/agent-studio/templates", params={"offset": -1}, headers=USER_HEADERS)
    assert negative_offset.status_code == 422
...
def test_get_template_returns_latest_version_by_default_and_exact_version_when_pinned(
    ...
    latest = client.get("/api/agent-studio/templates/template-research-qa", headers=USER_HEADERS)
    assert latest.status_code == 200
    assert latest.json()["version"] == "v1"

    pinned = client.get(
        "/api/agent-studio/templates/template-research-qa",
        params={"version": "v1"},
        headers=USER_HEADERS,
    )
...
def test_get_template_returns_404_for_unknown_id_or_version(client: TestClient) -> None:
    unknown_id = client.get("/api/agent-studio/templates/template-does-not-exist", headers=USER_HEADERS)
...
def _create_evaluation_suite(
    ...
    *,
    ...
    response = client.post(
        f"/api/agent-studio/agents/{logical_agent_id}/evaluation-suites",
        json=_body(
            project_id,
            name=name,
...
def test_create_list_and_get_evaluation_suite(client: TestClient) -> None:
    ...
    listing = client.get(
        "/api/agent-studio/agents/agent-eval-suite/evaluation-suites",
        params=_params(),
        headers=USER_HEADERS,
    )
    ...
    fetched = client.get(
        f"/api/agent-studio/agents/agent-eval-suite/evaluation-suites/{suite['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    ...
    wrong_agent = client.get(
        f"/api/agent-studio/agents/agent-does-not-exist/evaluation-suites/{suite['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    ...
    unknown_suite = client.get(
        "/api/agent-studio/agents/agent-eval-suite/evaluation-suites/missing-suite",
        params=_params(),
        headers=USER_HEADERS,
    )
    ...
    other_agent_listing = client.get(
        "/api/agent-studio/agents/agent-does-not-exist/evaluation-suites",
        params=_params(),
        headers=USER_HEADERS,
    )
...
def test_get_evaluation_suite_is_not_found_cross_project(
    ...
    cross_project = client.get(
        f"/api/agent-studio/agents/agent-eval-cross-scope/evaluation-suites/{suite['id']}",
...
def test_create_evaluation_suite_requires_contributor_role(client: TestClient) -> None:
    ...
    forbidden = client.post(
        "/api/agent-studio/agents/agent-eval-guard/evaluation-suites",
...
def test_create_evaluation_run_against_current_draft_with_in_memory_runner(
    ...
    response = client.post(
        f"/api/agent-studio/agents/agent-eval-run-draft/evaluation-suites/{suite['id']}/runs",
        json=_body(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 201, response.text
...
def test_create_evaluation_run_against_pinned_version(evaluation_available_client: TestClient) -> None:
    ...
    response = client.post(
        f"/api/agent-studio/agents/agent-eval-run-version/evaluation-suites/{suite['id']}/runs",
...
def test_create_evaluation_run_is_unavailable_without_a_wired_runner(client: TestClient) -> None:
    ...
    response = client.post(
        f"/api/agent-studio/agents/agent-eval-run-unavailable/evaluation-suites/{suite['id']}/runs",
        json=_body(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 503
    ...
    history = client.get(
        "/api/agent-studio/agents/agent-eval-run-unavailable/evaluation-runs",
        params=_params(),
        headers=USER_HEADERS,
    )
...
def test_create_evaluation_run_requires_contributor_role(evaluation_available_client: TestClient) -> None:
    ...
    forbidden = client.post(
        f"/api/agent-studio/agents/agent-eval-run-guard/evaluation-suites/{suite['id']}/runs",
        json=_body(),
        headers=VIEWER_HEADERS,
    )
    assert forbidden.status_code == 403
...
def test_create_evaluation_run_returns_404_for_missing_suite_version_or_agent(
    ...
    missing_suite = client.post(
        "/api/agent-studio/agents/agent-eval-run-missing/evaluation-suites/missing-suite/runs",
        json=_body(),
        headers=USER_HEADERS,
    )
    ...
    missing_version = client.post(
        f"/api/agent-studio/agents/agent-eval-run-missing/evaluation-suites/{suite['id']}/runs",
    ...
    missing_agent = client.post(
        f"/api/agent-studio/agents/agent-does-not-exist/evaluation-suites/{suite['id']}/runs",
        json=_body(),
        headers=USER_HEADERS,
    )
...
def test_create_evaluation_run_returns_404_when_draft_is_missing_for_authorized_role(
    ...
    response = client.post(
        f"/api/agent-studio/agents/agent-eval-no-draft/evaluation-suites/{suite['id']}/runs",
        json=_body(),
        headers=USER_HEADERS,
    )
...
def test_list_and_get_evaluation_runs_scoped_and_filtered_by_suite(
    ...
    def _trigger(suite_id: str) -> dict[str, Any]:
        response = client.post(
            f"/api/agent-studio/agents/agent-eval-history/evaluation-suites/{suite_id}/runs",
            json=_body(),
            headers=USER_HEADERS,
        )
        assert response.status_code == 201, response.text
    ...
    all_runs = client.get(
        "/api/agent-studio/agents/agent-eval-history/evaluation-runs",
        params=_params(),
        headers=USER_HEADERS,
    )
    ...
    fetched = client.get(
        f"/api/agent-studio/agents/agent-eval-history/evaluation-runs/{run_a['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert fetched.status_code == 200
    ...
    wrong_agent = client.get(
        f"/api/agent-studio/agents/agent-does-not-exist/evaluation-runs/{run_a['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert wrong_agent.status_code == 404
    ...
    unknown_run = client.get(
        "/api/agent-studio/agents/agent-eval-history/evaluation-runs/missing-run",
        params=_params(),
        headers=USER_HEADERS,
    )
...
def _create_test_run(
    ...
    *,
    ...
    response = client.post(
        f"/api/agent-studio/agents/{logical_agent_id}/test-runs",
...
def test_create_test_run_against_current_draft_with_in_memory_invoker(
    ...
    listing = client.get(
        "/api/agent-studio/agents/agent-test-run-draft/test-runs",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert listing.status_code == 200
    ...
    fetched = client.get(
        f"/api/agent-studio/agents/agent-test-run-draft/test-runs/{run['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert fetched.status_code == 200
    ...
    wrong_agent = client.get(
        f"/api/agent-studio/agents/agent-does-not-exist/test-runs/{run['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert wrong_agent.status_code == 404
    ...
    unknown_run = client.get(
        "/api/agent-studio/agents/agent-test-run-draft/test-runs/missing-run",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert unknown_run.status_code == 404
    ...
    other_agent_listing = client.get(
        "/api/agent-studio/agents/agent-does-not-exist/test-runs",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert other_agent_listing.status_code == 200
...
def test_get_test_run_is_not_found_cross_project(
    ...
    cross_project = client.get(
        f"/api/agent-studio/agents/agent-test-run-cross-scope/test-runs/{run['id']}",
        params=_params(OTHER_PROJECT_ID),
        headers=MULTI_PROJECT_USER_HEADERS,
    )
    assert cross_project.status_code == 404
...
def test_create_test_run_is_unavailable_without_a_wired_invoker(client: TestClient) -> None:
    ...
    response = client.post(
        "/api/agent-studio/agents/agent-test-run-unavailable/test-runs",
        json=_body(input="hi"),
        headers=USER_HEADERS,
    )
    assert response.status_code == 503
...
def test_create_test_run_requires_contributor_role(playground_available_client: TestClient) -> None:
    ...
    forbidden = client.post(
        "/api/agent-studio/agents/agent-test-run-guard/test-runs",
        json=_body(input="hi"),
        headers=VIEWER_HEADERS,
    )
    assert forbidden.status_code == 403
...
def test_create_test_run_returns_404_for_missing_version_or_agent(
    ...
    missing_version = client.post(
        "/api/agent-studio/agents/agent-test-run-missing/test-runs",
...
def test_create_test_run_returns_404_when_draft_is_missing_for_authorized_role(
    ...
    response = client.post(
        "/api/agent-studio/agents/agent-test-run-no-draft/test-runs",
        json=_body(input="hi"),
        headers=USER_HEADERS,
    )
    assert response.status_code == 404
...
def test_list_and_get_test_runs_scoped_and_filtered_by_version(
    ...
    all_runs = client.get(
        "/api/agent-studio/agents/agent-test-run-history/test-runs",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert all_runs.status_code == 200
    ...
    fetched = client.get(
        f"/api/agent-studio/agents/agent-test-run-history/test-runs/{draft_run['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert fetched.status_code == 200
    ...
    wrong_agent = client.get(
        f"/api/agent-studio/agents/agent-does-not-exist/test-runs/{draft_run['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert wrong_agent.status_code == 404
    ...
    unknown_run = client.get(
        "/api/agent-studio/agents/agent-test-run-history/test-runs/missing-run",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert unknown_run.status_code == 404
...
def test_fork_agent_rejects_reserved_platform_project_id(client: TestClient) -> None:
    ...
    forbidden_response = client.post(
        "/api/agent-studio/agents/agent-fork-reserved-source/fork",
        json=_body(
            PLATFORM_PROJECT_ID,
            source_version_id=source_version["id"],
...
def test_capability_approval_routes_gate_release_until_approved(
    ...
    missing_version_request = client.post(
        "/api/agent-studio/versions/missing/capability-approvals",
        json=_body(
            descriptor_id="foundry.azure_functions",
            operation="invoke",
    ...
    request_response = client.post(
        f"/api/agent-studio/versions/{version['id']}/capability-approvals",
        json=_body(
            descriptor_id="foundry.azure_functions",
            operation="invoke",
...
def test_resolve_approval_context_route_resolves_and_can_be_consumed(
    ...
    consume_response = client.post(
        f"/api/agent-studio/approvals/{body['approval_id']}/consume",
        json=_consume_body(
            binding_id=binding["binding_id"],
...
def test_get_release_attestation_route_returns_signed_attestation(
    ...
    response = client.get(
        f"/api/agent-studio/releases/{release['id']}/attestation",
        params={"project_id": DEFAULT_PROJECT_ID},
        headers=USER_HEADERS,
    )
    assert response.status_code == 200, response.text
...
def test_get_release_attestation_route_is_not_found_for_missing_or_ungated_release(
    ...
    missing = client.get(
        "/api/agent-studio/releases/missing-release/attestation",
        params={"project_id": DEFAULT_PROJECT_ID},
        headers=USER_HEADERS,
    )
    assert missing.status_code == 404
...
def test_get_release_attestation_route_returns_503_when_persistence_unavailable(
    ...
    response = unavailable_client.get(
        "/api/agent-studio/releases/release-1/attestation",
        params={"project_id": DEFAULT_PROJECT_ID},
        headers=USER_HEADERS,
    )
    assert response.status_code == 503
...
def test_record_health_requires_maintainer_role_at_router_and_service(
    ...
    unchanged = client.get(
        "/api/agent-studio/agents/agent-health-authz/deployments",
        params=_params(),
        headers=USER_HEADERS,
    )
...
def test_resolve_contract_and_catalog_routes_cover_full_happy_path(
    ...
    pre_release_contract = client.get(
        f"/api/agent-studio/versions/{contract_version['id']}/contract",
    ...
    activate_response = client.post(
        f"/api/agent-studio/versions/{contract_version['id']}/activate",
        json=_body(),
        headers=USER_HEADERS,
    )
    ...
    resolve_response = client.get(
        "/api/agent-studio/agents/agent-contract/resolve",
        params=_params(environment="development"),
        headers=USER_HEADERS,
    )
...
def test_activate_route_covers_missing_version_authorization_and_conflict(
    ...
    missing_activate = client.post(
        "/api/agent-studio/versions/missing-version/activate",
        json=_body(),
        headers=USER_HEADERS,
    )
    ...
    forbidden_activate = client.post(
        f"/api/agent-studio/versions/{version['id']}/activate",
        json=_body(),
        headers=contributor_headers,
    )
...
def test_memory_routes_cover_policy_errors_missing_records_and_unavailability(
    ...
    (
        "GET",
        f"/api/agent-studio/agents/agent-memory-missing-entry/memory/missing-entry?project_id={DEFAULT_PROJECT_ID}",
        None,
    ),
        (
            "PUT",
...
def test_builder_propose_apply_reject_flow_and_history(client: TestClient) -> None:
    ...
    history = client.get(
        "/api/agent-studio/agents/agent-builder/proposals",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert history.status_code == 200
...
def test_project_membership_is_enforced_for_every_identity(client: TestClient) -> None:
    ...
    missing_membership = client.get(
        "/api/agent-studio/agents/agent-project-membership/draft",
        params=_params(),
...
def test_project_membership_in_one_project_does_not_authorize_a_different_project(
    ...
    response = client.get(
        "/api/agent-studio/agents/agent-cross-project-membership/draft",
        params=_params(OTHER_PROJECT_ID),
        headers=USER_HEADERS,
    )
    assert response.status_code == 403
...
def test_group_overage_denies_access_even_when_target_group_is_present(client: TestClient) -> None:
    ...
    response = client.get(
        "/api/agent-studio/agents/agent-overage-with-group/draft",
        params=_params(),
        headers=overage_headers,
    )
    assert response.status_code == 403
...
def test_router_consults_app_composed_membership_resolver_when_present(client: TestClient) -> None:
    ...
    response = client.get(
        "/api/agent-studio/agents/agent-swapped-resolver/draft",
        params=_params(),
        headers=no_membership_headers,
    )
    assert response.status_code == 200, response.text
...
def test_router_denies_when_app_composed_resolver_reports_unavailable(client: TestClient) -> None:
    ...
    cast(Any, client).app.state.agent_studio_membership_resolver = resolver
    response = client.get(
        "/api/agent-studio/agents/agent-unavailable-resolver/draft",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 403
...
def test_draft_and_version_routes_are_cross_project_and_cross_tenant_isolated(
    ...
    cross_project_cut = client.post(
        "/api/agent-studio/agents/agent-scope-draft/versions",
        params=_params(OTHER_PROJECT_ID),
        headers=other_project_headers,
    )
...
def test_deployment_and_tool_routes_are_cross_project_and_cross_tenant_isolated(
    ...
    create_registration = client.post(
        "/api/agent-studio/agents/agent-scope-runtime/tool-registrations",
        json=_body(
            descriptor_id="foundry.web_search",
            operation="search",
            kind="managed_foundry_native",
    ...
    for headers, project_id in (
        ...
        assert client.get(
            "/api/agent-studio/agents/agent-scope-runtime/deployments",
            params=_params(project_id),
            headers=headers,
        ).json() == []
...
def test_builder_and_memory_routes_are_cross_project_and_cross_tenant_isolated(
    ...
    proposal = client.post(
        "/api/agent-studio/agents/agent-scope-builder-memory/builder/messages",
        json=_body(message="seed proposal", base_etag=draft["etag"]),
        headers=USER_HEADERS,
    ).json()
    entry = client.post(
        "/api/agent-studio/agents/agent-scope-builder-memory/memory",
    ...
    for headers, project_id in (
        ...
        assert client.get(
            "/api/agent-studio/agents/agent-scope-builder-memory/proposals",
            params=_params(project_id),
            headers=headers,
        ).json() == []
        fetch = client.get(
            f"/api/agent-studio/agents/agent-scope-builder-memory/proposals/{proposal['id']}",
            params=_params(project_id),
            headers=headers,
        )
        ...
        inspect = client.get(
            f"/api/agent-studio/agents/agent-scope-builder-memory/memory/{entry['id']}",
            params=_params(project_id),
            headers=headers,
        )
        ...
        export = client.get(
            "/api/agent-studio/agents/agent-scope-builder-memory/memory-export",
            params=_params(project_id, scope_kind="conversation", scope_id="thread-1"),
            headers=headers,
        )
...
def test_draft_view_includes_capability_views_sidecar(
    ...
    response = client.get(
        "/api/agent-studio/agents/agent-draft-capability-view/draft",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 200, response.text
...
def test_draft_view_is_project_scoped_not_found_for_missing_or_cross_scope(
    ...
    missing = client.get(
        "/api/agent-studio/agents/agent-does-not-exist/draft",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert missing.status_code == 404
...
def test_version_capability_views_route_returns_expanded_bindings(
    ...
    response = client.get(
        f"/api/agent-studio/versions/{version['id']}/capability-views",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 200, response.text
    ...
    missing = client.get(
        "/api/agent-studio/versions/missing-version/capability-views",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert missing.status_code == 404
...
def test_agent_workspace_route_aggregates_draft_version_release_and_deployments(
    ...
    response = client.get(
        "/api/agent-studio/agents/agent-workspace/workspace",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 200, response.text
...
def test_agent_workspace_route_handles_agent_without_any_version_yet(client: TestClient) -> None:
    ...
    response = client.get(
        "/api/agent-studio/agents/agent-workspace-fresh/workspace",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 200, response.text
...
def test_agent_workspace_route_is_not_found_for_missing_or_cross_scope_agent(
    ...
    missing = client.get(
        "/api/agent-studio/agents/agent-workspace-missing/workspace",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert missing.status_code == 404
    ...
    cross_tenant = client.get(
        "/api/agent-studio/agents/agent-workspace-scoped/workspace",
        params=_params(),
        headers=OTHER_TENANT_HEADERS,
    )
    assert cross_tenant.status_code == 404
...
def test_get_approval_route_returns_effective_state_and_is_scope_authorized(
    ...
    response = client.get(
        f"/api/agent-studio/approvals/{approval['id']}",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert response.status_code == 200, response.text
    ...
    missing = client.get(
        "/api/agent-studio/approvals/missing-approval",
        params=_params(),
        headers=USER_HEADERS,
    )
    assert missing.status_code == 404
...
def test_revoke_approval_route_self_revocation_then_blocks_further_decisions(
    ...
    revoke = client.post(
        f"/api/agent-studio/approvals/{approval['id']}/revoke",
...
def test_revoke_approval_route_is_not_found_for_missing_or_cross_scope_approval(
    ...
    missing = client.post(
        "/api/agent-studio/approvals/missing-approval/revoke",
...
def test_audit_events_recorded_for_agent_lifecycle_routes(
    ...
    register_response = client.post(
        "/api/agent-studio/agents/agent-audit-lifecycle/tool-registrations",
        json=_body(
            descriptor_id="foundry.web_search",
            operation="search",
            kind="managed_foundry_native",
    ...
    fork_response = client.post(
        "/api/agent-studio/agents/agent-audit-lifecycle/fork",
    ...
    rollback_response = client.post(
        "/api/agent-studio/agents/agent-audit-lifecycle/rollback",
...
def test_audit_events_recorded_for_escalation_and_builder_apply_routes(
    ...
    request_response = client.post(
        "/api/agent-studio/agents/agent-audit-escalation/escalations",
        json=_body(requested_role="maintainer", evidence_summary="need write access"),
        headers=VIEWER_HEADERS,
    )
    ...
    propose = client.post(
        "/api/agent-studio/agents/agent-audit-builder/builder/messages",
        json=_body(message="Add a helpful description.", base_etag=draft["etag"]),
        headers=USER_HEADERS,
    )
    assert propose.status_code == 201, propose.text
    proposal = propose.json()
    apply_response = client.post(
        f"/api/agent-studio/agents/agent-audit-builder/proposals/{proposal['id']}/apply",
        json=_body(base_etag=draft["etag"]),
        headers=USER_HEADERS,
    )
    assert apply_response.status_code == 200, apply_response.text
...
def test_audit_unavailable_client_fails_closed_before_every_wired_mutation(
    ...
    update_response = audit_unavailable_client.put(
        "/api/agent-studio/agents/agent-audit-503/draft",
        json={"manifest": draft["manifest"]},
        headers={**USER_HEADERS, "If-Match": draft["etag"]},
    )
    ...
    register_response = audit_unavailable_client.post(
        "/api/agent-studio/agents/agent-audit-503/tool-registrations",
        json=_body(
            descriptor_id="foundry.web_search",
            operation="search",
            kind="managed_foundry_native",
    ...
    cut_response = audit_unavailable_client.post(
        "/api/agent-studio/agents/agent-audit-503/versions",
        params=_params(),
        headers=USER_HEADERS,
    )
    ...
    fork_response = audit_unavailable_client.post(
        "/api/agent-studio/agents/agent-audit-503/fork",
    ...
    escalation_response = audit_unavailable_client.post(
        "/api/agent-studio/agents/agent-audit-503/escalations",
        json=_body(requested_role="maintainer", evidence_summary="need write access"),
        headers=VIEWER_HEADERS,
    )
    ...
    deploy_response = audit_unavailable_client.post(
        "/api/agent-studio/agents/agent-audit-503/deployments",
        json=_body(version_id=version["id"]),
        headers=USER_HEADERS,
    )
    ...
    rollback_response = audit_unavailable_client.post(
        "/api/agent-studio/agents/agent-audit-503/rollback",
    ...
    builder_proposal = client.post(
        "/api/agent-studio/agents/agent-audit-503-builder/builder/messages",
        json=_body(message="Add a helpful description.", base_etag=builder_draft["etag"]),
        headers=USER_HEADERS,
    ).json()
    apply_response = audit_unavailable_client.post(
        f"/api/agent-studio/agents/agent-audit-503-builder/proposals/{builder_proposal['id']}/apply",
